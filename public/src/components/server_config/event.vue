...
<i18n>
{
    ...
    "zh": {
        "add_session_button": "添加一场比赛",
        "add_sessions_p_q_r_button": "添加一场比赛 （练习/排位/正赛）",
        "add_sessions_q_r_button": "添加一场比赛 （排位/正赛）",
        "ambienttemp_label": "环境温度",
        "clear_sessions_button": "清除所有比赛",
        "cloudlevel_label": "云级别",
        "confirm_clear_sessions": "您真的要删除所有比赛吗？",
        "isFixedConditionQualification_label": "是否固定的天气条件在排位赛中",
        "metadata_label": "元数据",
        "postqualyseconds_label": "",
        "postraceseconds_label": "",
        "preracewaitingtimeseconds_label": "赛前等待时间（秒）",
        "rain_label": "雨",
        "sessionovertimeseconds_label": "会话超时秒数",
        "simracerWeatherConditions_label": "",
        "title": "比赛设定",
        "track_label": "赛道",
        "tracktemp_label": "赛道温度（空则省略）",
        "weatherrandomness_label": "天气随机性"
    }
}
</i18n>
